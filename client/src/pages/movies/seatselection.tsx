    ...
    <div className="mx-auto max-w-5xl px-5 py-7 pb-16">
      ...
      <div className="mb-6 flex justify-center gap-5 text-xs text-muted">
        <span className="inline-flex items-center gap-1.5">
          <i className="inline-block h-2.5 w-2.5 rounded border border-border bg-surface2" /> 선택 가능
        </span>
        <span className="inline-flex items-center gap-1.5">
          <i className="inline-block h-2.5 w-2.5 rounded border border-primary bg-primary" /> 선택됨
        </span>
        <span className="inline-flex items-center gap-1.5">
          <i className="inline-block h-2.5 w-2.5 rounded border border-border bg-[#2a2d33]" /> 예약됨
        </span>
      </div>
      ...
      <div className="sticky bottom-0 flex items-center justify-between rounded-xl border border-border bg-surface px-5 py-4">
        <div>
          ...
          <p className="m-0 text-lg font-bold">
            {(selectedSeatIds.length * PRICE_PER_SEAT).toLocaleString()}원
          </p>
        </div>
        <button
          type="button"
